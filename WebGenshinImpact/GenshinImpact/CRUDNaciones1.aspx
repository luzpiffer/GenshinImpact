<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CRUDNaciones1.aspx.vb" Inherits="GenshinImpact.CRUDNaciones1" %>
    ...
    <form id="form1" runat="server">
        <div class="hero_area">
            ...
            <table style="width: 100%;">
                <tr>
                    <td style="width: 221px; height: 18px;">ID: </td>
                    <td class="auto-style3">
                        <asp:TextBox ID="txtid" runat="server"></asp:TextBox>
                    </td>
                    <td style="height: 18px; width: 134px">
                ...
                <tr>
                    ...
                    <td class="auto-style4">
                        <asp:TextBox ID="txtnacion" runat="server"></asp:TextBox>
                    </td>
                    <td class="auto-style7">
                        <asp:Button ID="btneliminar" runat="server" Text="Eliminar" Width="119px" CssClass="botonRedondeado" />
                    </td>
                    <td class="auto-style8">
                        <asp:Button ID="btnmostartodo" runat="server" Text="Mostrar Todo" CssClass="botonRedondeado" />
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <asp:Button ID="btnconsultarnacion" runat="server" Text="Consultar Nación" CssClass="botonRedondeado" />
                    </td>
                </tr>
                <tr>
