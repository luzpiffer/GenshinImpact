<%@ Page Language="VB" AutoEventWireup="true" CodeBehind="ConsultarPedidosDetalles.aspx.vb" Inherits="GenshinImpact.ConsultarPedidosDetalles" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>Consultar Detalles de Pedidos</title>
...
<body>
    <form id="form1" runat="server">
        <div class="hero_area">
            ...
            <div>
                <h4 style="margin-top: 30px;">Detalles de Pedidos</h4>
                ...
                <asp:GridView ID="GridViewDetalles" runat="server" AutoGenerateColumns="False">
                    <Columns>
                        <asp:BoundField DataField="DetalleId" HeaderText="ID del Detalle" />
                        <asp:BoundField DataField="PedidoId" HeaderText="ID del Pedido" />
                        <asp:BoundField DataField="ID_Personaje" HeaderText="ID del Personaje" />
