<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Nosotros.aspx.vb" Inherits="GenshinImpact.Nosotros" %>
...
<div class="tienda-info" style="background-image: url('ruta/a/tu/imagen.jpg'); background-size: cover; padding: 50px; color: white;">
  <div class="container33">
    <h2 style="text-align: center;">Sobre nosotros</h2>
    <p style="text-align: center;">
      En Peluches Teyvat, te ofrecemos los mejores peluches de tus personajes favoritos de Genshin Impact. Diseñados con amor y materiales de alta calidad, garantizamos productos increíbles y atención al cliente de primera. ¡Explorá nuestra tienda y encontrá tu peluche ideal!
    </p>
  </div>
</div>
<!-- Sección del por qué -->
      ...
      <div class="col-md-4">
        <div class="box ">
          ...
          <div class="detail-box">
            ...
            <p>
              Recibe tus pedidos en tiempo récord, directamente en la puerta de tu casa
            </p>
          </div>
        </div>
      </div>
      <div class="col-md-4">
        <div class="box ">
          ...
          <div class="detail-box">
            ...
            <p>
              Disfruta de envío sin costo adicional en todas tus compras, ¡así de fácil!
            </p>
          </div>
        </div>
      </div>
      <div class="col-md-4">
        <div class="box ">
          ...
          <div class="detail-box">
            ...
            <p>
              Nuestros productos están para ofrecerte lo mejor en calidad
            </p>
          </div>
        </div>
      </div>
